...
const Form = ({ isUserLoggedIn }) => {
  ...
  const handlePageSubmit = async (e) => {
    ...
    const data = {
      ...
      hardworking: otherInfo.hardwork,
      senseofhumour: otherInfo.senseofhumour,
      punctualilty: otherInfo.punctual,
      creativity: otherInfo.creative,
      problemSolving: otherInfo.prob_solving,
      responsibility: otherInfo.responsible,
    };
